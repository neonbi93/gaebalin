...
CREATE TABLE TB_PRODUCT_REPLY(
  ...
  CONSTRAINT TB_PRODUCT_REPLY_FK_USER FOREIGN KEY(USER_CODE) REFERENCES TB_COM_USER(USER_CODE)
);
...
CREATE TABLE TB_PRODUCT_MARK(
  ...
  CONSTRAINT TB_PRODUCT_MARK_FK_USER FOREIGN KEY(USER_CODE) REFERENCES TB_COM_USER(USER_CODE)
);
...
CREATE TABLE TB_EVENT_REPLY(
  ...
  CONSTRAINT TB_EVENT_REPLY_FK_USER FOREIGN KEY(USER_CODE) REFERENCES TB_COM_USER(USER_CODE)
);
...
CREATE TABLE TB_EVENT_MARK(
  ...
  CONSTRAINT TB_EVENT_MARK_FK_USER FOREIGN KEY(USER_CODE) REFERENCES TB_COM_USER(USER_CODE)
);
...
CREATE TABLE TB_QNA(
 ...
 CONSTRAINT TB_QNA_FK_USER FOREIGN KEY(USER_CODE) REFERENCES TB_COM_USER(USER_CODE),
 CONSTRAINT TB_QNA_FK_RESPONSE FOREIGN KEY(RESPONSE_USER) REFERENCES TB_COM_USER(USER_CODE)
);
