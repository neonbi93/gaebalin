		...
		<div class="main_menu_w">
			<ul>
				<li><a href="${context}/work/product/retrieveProductList.do"><img
						src="${context}/mobile/main_images/book.jpg" width="100" alt="도서구매" /></a>
						<span>도서 구매</span></li>

				<li><a href="${context}/work/introduce/main.do"><img src="${context}/mobile/main_images/introduce.jpg"
						alt="개발인소개" width="100" /></a><span>개발인소개</span></li>

				<li><a href="${context}/work/event/createEvent.do"><img
						src="${context}/mobile/main_images/event.png" width="100" alt="행사"/></a>
						<span>행사</span></li>

				<li><a href="${context}/work/sche/retrieveScheList.do"><img
						src="${context}/mobile/main_images/notice.png" width="100"
						alt="공지사항" /></a> <span>공지사항</span></li>

				<li><a href="${context}/work/board/retrieveBoardList.do"><img
						src="${context}/mobile/main_images/board.png" width="150" alt="게시판" /></a>
						<span>게시판</span></li>

				<li><a href="${context}/user/login.jsp"><img
						src="${context}/mobile/main_images/login1.png" width="100"
